...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "worlddomination" because\n';
  ...
  $wnd.__gwt_activeModules['worlddomination'] = {
    'moduleName' : 'worlddomination',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/worlddomination.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['worlddomination'].superdevmode = true;

  var expectedSuffix = '/worlddomination.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + worlddomination + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:worlddomination';
  var devModeSessionKey = '__gwtDevModeSession:worlddomination';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/worlddomination/worlddomination.nocache.js';
  ...
  $wnd.__gwt_activeModules['worlddomination'].canRedirect = true;
  $wnd.__gwt_activeModules['worlddomination'].superdevmode = true;
  ...
  css = (moduleIdx == 1 ? css : '') +
    ".gwt-DevModeModule-" + moduleIdx + ".gwt-DevModeCompiling div:before{" +
      "content:'COMPILING worlddomination';" +
      "font-size:24px;" +
      "color:#d2d9ee;" +
    "}";
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/worlddomination?user.agent=' + ua + '&_callback=' + callback;
